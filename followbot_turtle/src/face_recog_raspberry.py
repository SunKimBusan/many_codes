...
class FaceRecog():
    def __init__(self):
        ...
        self.img_sub = rospy.Subscriber('/raspicam_node/image/compressed', CompressedImage, self.callback_img)
        self.cv_image = None
    ...
    def callback_img(self,data):
      try:
        ...
        self.cv_image = image_np = cv2.imdecode(np_arr, cv2.IMREAD_COLOR) # OpenCV >= 3.0
